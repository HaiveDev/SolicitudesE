...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    /**
     *
     * @param {Enevent} event - the event to process
     */
    ...
    /**
     * @returns the submenu animation state based on the root and active status
     */
    ...
    /**
     * @returns true if the menuitem is active and not a root menuitem
     */
