...
@Component({
    selector: 'app-dist-coordinator-history',
    standalone: true,
...
export class DistCoordinatorHistoryComponent implements OnInit, OnDestroy {
    ...
    public redirection = RedirectionHistory.dist_coordinador;
