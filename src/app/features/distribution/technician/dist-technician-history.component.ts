...
@Component({
    selector: 'app-dist-technician-history',
    standalone: true,
...
export class DistTechnicianHistoryComponent implements OnInit, OnDestroy {
    ...
    public redirection = RedirectionHistory.dist_tecnico;
